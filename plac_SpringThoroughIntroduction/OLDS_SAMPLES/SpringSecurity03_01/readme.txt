...
URL　:　 http://localhost:8080/SpringSecurity03_01/
...
redhandsj <redhandsj@redhandsj.com>
 ...
 http://localhost:8080/SpringSecurity03_01/
   → アクセス可能
 http://localhost:8080/SpringSecurity03_01/admin
   → 権限admin
 http://localhost:8080/SpringSecurity03_01/logout
   → 権限admin
