...
import org.rhpj.component.Cart;
...
public class DataSourceConfig {
	...
	public DataSource dataSource(
			@Value("${datasource.scriptencoding}") String scriptEncoding,
			@Value("${datasource.scriptschema}") String scriptSchema,
			@Value("${datasource.scriptdata}") String scriptData) {
		try {
