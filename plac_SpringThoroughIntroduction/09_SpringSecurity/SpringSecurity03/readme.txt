...
しおり　：　P.190      (～202)
URL　:　 http://localhost:8080/SpringSecurity03/welcome
※残りは、読んでおく。
...
redhandsj <redhandsj@redhandsj.com>
 ...
 http://localhost:8080/SpringSecurity03/
   → アクセス可能
 http://localhost:8080/SpringSecurity03/admin
   → 権限admin
 http://localhost:8080/SpringSecurity03/logout
   → 権限admin
